...
public class Pipelining {
	...
	private static int j=0,halt=0,inst_count=0,wb_z=0,CPI=0,ans=0;
    ...
    ActionListener taskPerformer = new ActionListener() {
        public void actionPerformed(ActionEvent evt) {
        	   ...
        	   //else
        	   {
        		   ...
        		   /////////////////////////
        		   if((halt==1) && (WB[0].equals(""))&& (WB[1].equals(""))&& (WB[2].equals(""))&& (WB[3].equals(""))&& (WB[4].equals(""))&& (WB[5].equals("")))
        		   {
        			   ans=CPI;
        		   ...
        		   ////////////////////////
        		   	System.out.println(op1[5]+"_____"+op1[4]+"______"+op1[3]);
		           	op3[5]=op3[4];
		           	op2[5]=op2[4];
		           	op1[5]=op1[4];
		           	...
		           	//WRITE BACK STAGE
	            	String WBStage="";
	            	if(operator[5].equals("011"))
	            	{
	            		WBStage+="R"+WB[5]+" <---- "+"LMD";
	            		if(!WB[5].equals("") && !ALU[5].equals(""))
	            			txt[Integer.parseInt(WB[5])].setText(LMD[5]);
	            	}
	            	else
	            	{
	            		WBStage+="R"+WB[5]+" <---- "+"ALUOutput";
	            		if(!WB[5].equals("") && !ALU[5].equals(""))
	            			txt[Integer.parseInt(WB[5])].setText(ALU[5]);
	            	}
	            	if(WB[5].equals(""))
	            		txt[34].setText("WB STALL ..");
	            	else
	            		txt[34].setText(WBStage);
	            	...
	            	WB[4]=WB[3];
	            	String MEMStage="";
	            	if(operator[4].equals("011"))
	            	{
	            		MEMStage+="LMD <---- D$["+ALU[4]+"]";
	            		LMD[4]=txt[Integer.parseInt(ALU[4])].getText();
	            	}
	            	if(operator[4].equals("100"))
	            	{
	            		MEMStage+="D$["+ALU[4]+"]"+" <---- "+op3[4];
	            		txt[Integer.parseInt(ALU[4])].setText(op3[4]);
	            	}
	            	if(WB[4].equals(""))
	            		txt[33].setText("MEM STALL  .."+WB[3]);
	            	else
	            	{
	            		if(MEMStage.equals(""))
	            			txt[33].setText("----");
	            		else
	            			txt[33].setText(MEMStage);
	            	}
	            	...
	            	if(operator[3].equals("000"))
	            	{
	            		if(imm[3].equals("0"))
	            		{
	            			EXECStage+="ALUOutput <---- R"+op2[3]+" + R"+op3[3];
	            			int oprnd1,oprnd2;
	            			oprnd1=Integer.parseInt(txt[Integer.parseInt(op2[3])].getText());
	            			oprnd2=Integer.parseInt(txt[Integer.parseInt(op3[3])].getText());
	            			ALU[3]=Integer.toString(oprnd1+oprnd2);
	            		}
	            		else if(imm[3].equals("1"))
	            		{
	            			EXECStage+="ALUOutput <---- R"+op2[3]+" + "+op3[3];
	            			int oprnd1,oprnd2;
	            			oprnd1=Integer.parseInt(txt[Integer.parseInt(op2[3])].getText());
	            			oprnd2=Integer.parseInt(op3[3]);
	            			ALU[3]=Integer.toString(oprnd1+oprnd2);
	            		}
	            		txt[32].setText(EXECStage+"  "+WB[3]);
	            		
	            	}
	            	if(operator[3].equals("001"))
	            	{
	            		if(imm[3].equals("0"))
	            		{
	            			EXECStage+="ALUOutput <---- R"+op2[3]+" - R"+op3[3];
	            	...
	            	if(operator[3].equals("011"))
	            	{
	            		if(imm[3].equals("0"))
	            		{
	            			EXECStage+="ALUOutput <---- R0"+" + R"+op2[3];
	            			int oprnd1,oprnd2;
	            			oprnd1=Integer.parseInt(txt[Integer.parseInt(op2[3])].getText());
	            			ALU[3]=Integer.toString(oprnd1);
	            		}
	            		else if(imm[3].equals("1"))
	            		{
	            			EXECStage+="ALUOutput <---- R0"+" + "+op3[3];
	            			int oprnd1,oprnd2;
	            			oprnd1=Integer.parseInt(op3[3]);
	            			ALU[3]=Integer.toString(oprnd1);
	            		}
	            		txt[32].setText(EXECStage);
	            	}
	            	if(operator[3].equals("100"))
	            	{
	            		if(imm[3].equals("0"))
	            		{
	            			EXECStage+="ALUOutput <---- R0"+" + R"+op3[3];
	            			int oprnd1,oprnd2;
	            			oprnd1=Integer.parseInt(txt[Integer.parseInt(op3[3])].getText());
	            			ALU[3]=Integer.toString(oprnd1);
	            		}
	            		else if(imm[3].equals("1"))
	            		{
	            	...
	            	if(operator[3].equals("101"))
	            	{
	            		CPC=Integer.parseInt(op1[3]);
	            		System.out.println(".....Hello ggs "+op1[3]);
	            	...
	            	//DATA FETCH
	            	String Fetch="";
            		System.out.println(op1[3] + "  " + op1[4] + "  "+op1[5]+"_____"+"/////"+op2[1]+"   "+op3[1]);
	            	if((op1[3].equals(op2[1]) || op1[3].equals(op3[1]) || op1[4].equals(op2[1]) || op1[4].equals(op3[1]) || op1[5].equals(op2[1]) || op1[5].equals(op3[1])) && (!WB[1].equals("")))
	            	{
	            		System.out.println("CCCCCCCCCCCCCCCCCCCCCCCCCCc");
	            		System.out.println(op1[3] + "  " + op1[4] + "  "+op1[5]+"/////"+op2[1]+"   "+op3[1]);
	            		op3[2]="";
	                	op2[2]="";
	                	op1[2]="";
	                	operator[2]="";
	            	...
	            	if(WB[2].equals(""))
	            		txt[31].setText("DF STALL");
	            	else
	            	{
		            	if(imm[2].equals("0"))
		            	{
		            		Fetch+="A <---- R"+op2[2]+"; B <---- R"+op3[2]+";";
		            	}
		            	else if(imm[2].equals("1"))
		            	{
		            		Fetch+="A <---- R"+op2[2]+"; Imm <---- "+op3[2]+";";
		            	}
	            	...
	            	if(stall==1)
	            	{
	            		txt[30].setText("HELLO");
	            	}
	            	else if(InstFetch.length()==0)
	            	{
	            		op3[1]="";
	                	op2[1]="";
	                	op1[1]="";
	            	...
	            	else if(InstFetch.length()==16)
	            	{
	            		...
	            		//else
			            	...
			            	txt[30].setText(im+" "+top+" "+op1[1]+" "+op2[1]+" "+op3[1]+";");
			            	//txt[30].setText(InstFetch);
	            		}
		            	if(top.equals("111"))
		            	{
		            		halt=1;
	            	...
	            	else
	            	{
		                	...
		                	for(int i=28;i>16;--i)
		                	{
			                	txt[i].setText(txt[i-1].getText());
		                	}
		                	txt[16].setText(InstFetch);
		                	txt[29].setText(InstFetch);
		                	NPC=NPC+1;
	            	}
